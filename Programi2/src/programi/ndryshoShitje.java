 ...
 * @author Pc
 */
public class ndryshoShitje extends javax.swing.JFrame {

    /**
     * Creates new form ndryshoShitje
     */
    public ndryshoShitje() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ndryshimi i Shitjes ende eshte ne perpunim i nderuar!!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ndryshoShitje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ndryshoShitje().setVisible(true);
            }
        });
    }
